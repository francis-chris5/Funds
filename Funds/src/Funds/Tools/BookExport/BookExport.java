    ...
    public void write(){
        try{
            ...
            if(type == ExportType.XML){
                ...
                File initFile = new File(folder.getPath() + "/" + "initialize_" + book.getName().replace(" ", "_").replace(",", "").replace("(", "").replace(")", "").replace(".", "_").replace("-", "_") + "_DB.sql");
                String initString = new String("CREATE DATABASE IF NOT EXISTS " + book.getName().replace(" ", "_").replace(",", "").replace("(", "").replace(")", "").replace(".", "_").replace("-", "_") + "_DB;\n");
                initString += "USE " + book.getName().replace(" ", "_").replace(",", "").replace("(", "").replace(")", "").replace(".", "_").replace("-", "_") + "_DB;\n";
