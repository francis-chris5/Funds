 ...
 */
public class AccountCategoryDetailsDialog extends Dialog implements Initializable {
    ...
    public AccountCategoryDetailsDialog(Book book, AccountType type){
        this.book = book;
        this.type = type;
        ...
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("AccountCategoryDetailsDialogGUI.fxml"));
...
}//end AccountCategoryDetailsDialog
