 ...
 */
public class AccountDetailsDialog extends Dialog implements Initializable {
     ...
     */
    public AccountDetailsDialog(Book book, AccountType type){
        this.book = book;
        this.type = type;
        ...
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("AccountDetailsDialogGUI.fxml"));
     ...
     */
    public AccountDetailsDialog(Book book, AccountType type, AccountCategory parent){
        this.book = book;
        this.type = type;
        this.setTitle("Funds: New Account");
        Image icon = new Image(getClass().getResourceAsStream("../Images/FundsIcon.png"));
    ...
    public AccountDetailsDialog(Book book, Account account){
        this.book = book;
        this.account = account;
        this.type = this.account.getType();
        this.setTitle("Funds: Edit Account Details");
        Image icon = new Image(getClass().getResourceAsStream("../Images/FundsIcon.png"));
        Stage stage = (Stage)this.getDialogPane().getScene().getWindow();
        stage.getIcons().add(icon);
        try{
        ...
        txtNumber.setText(account.getNumber());
        txtRouting.setText(account.getRouting());
    ...
    public void editAccountDetails(){
        account.setType((AccountType)cmbType.getValue());
        account.setName(txtName.getText());
        account.setNormalDebit(rdDebit.isSelected());
        account.setNumber(txtNumber.getText());
        account.setRouting(txtRouting.getText());
        account.setCode(txtCode.getText());
        account.setDescription(txtDescription.getText());
        book.setSaved(false);
        book.displayDetails();
    }//end editAccountDetails();
