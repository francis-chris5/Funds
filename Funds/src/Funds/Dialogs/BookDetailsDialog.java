 ...
 */
public class BookDetailsDialog extends Dialog implements Initializable {
    ...
    public BookDetailsDialog(){
        ...
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("BookDetailsDialogGUI.fxml"));
