 ...
 */
public class AccountLedgerDialog extends Dialog implements Initializable {
     ...
     */
    public AccountLedgerDialog(Book book, Account account){
        this.book = book;
        ...
        try{
            FXMLLoader loader = new FXMLLoader(getClass().getResource("AccountLedgerDialogGUI.fxml"));
